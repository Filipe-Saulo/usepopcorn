...
export default function App() {
  ...
  function handleAddWatched(movie) {
    ...
    //adicionando no armazenamento local. setItem envia dois
    //argumentos o 1 é o key e o 2 e os dados, que estao descritos dessa forma pq
    //esta dentro de uma async function, assim o watched esta com valor obsoleto é necessario transformar em JSON.stringify
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>
                  Você já avaliou este filme {watchedUserRating}
                  <span>⭐</span>
                </p>
              )}
            </div>
